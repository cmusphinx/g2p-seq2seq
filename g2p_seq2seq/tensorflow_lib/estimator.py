...
from tensorflow_lib import evaluation
...
class BaseEstimator(
  ...
  def __init__(self, model_dir=None, config=None):
    ...
    if self._config.session_config is None:
      print('############################ALLOW_SOFT_PLACEMENT CONFIG')
  ...
  def evaluate(self,
    ...
    if metrics is not None and not isinstance(metrics, dict):
      raise ValueError('Metrics argument should be None or dict. '
                       'Got %s.' % metrics)
    print('-----------------EVALUATE_MODEL in EVALUATE--------------')
  ...
  def _evaluate_model(self,
    ...
    with ops.Graph().as_default() as g:
      ...
      #Tracer()()
      print('EVALUATE_ONCE STARTED')
      print('CHECKPOINT PATH: ', checkpoint_path)
      print('EVALUATION MASTER: ', self._config.evaluation_master)
      print('UPDATE_OP: ', update_op)
      print('EVAL_DICT: ', eval_dict),
      print('HOOKS: ', hooks)
      print('SESSION_CONFIG: ', self._session_config)
...
class Estimator(BaseEstimator):
  ...
  def _call_model_fn(self, features, labels, mode):
    ...
    """
    print('FEATURE_ENGINEERING_FN_1')
    ...
    print('STOP HERE 2')
    print('PREDICTIONS: ', model_fn_results[0])
    print('LOSS: ', model_fn_results[1])
    print('TRAIN_OP: ', model_fn_results[2])
  ...
  def _get_eval_ops(self, features, labels, metrics):
    ...
    """
    #Tracer()()
    print('____RUN_EVAL_MODE____')
    model_fn_ops = self._call_model_fn(
        features, labels, model_fn_lib.ModeKeys.EVAL)

    print('FEATURE_ENGINEERING_FN_2')
    features, labels = self._feature_engineering_fn(features, labels)
